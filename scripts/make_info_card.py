...
ROWS = [
    ("host",),
    ("kv", "Now", "AI Engineer & Builder"),
    ("kv", "Focus", "Agentic Systems, Harness, Loops"),
    ("kv", "OSS", "50+ merged PRs (Kubeflow, Ray, T3MP3ST)"),
    ("kv", "Edu", "B.Tech CSE · C4GT'26"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, C++, TypeScript"),
    ("kv", "AI / ML", "OpenAI, LangChain, Claude, Gemini"),
    ("kv", "Frameworks", "FastAPI, Next.js, Node.js"),
    ("kv", "Infra", "Docker, PostgreSQL, Redis, GCP"),
    ("gap",),
    ("sec", "Projects"),
    ("bul", "SHARP — The Harness System"),
    ("bul", "Nexus — Multi-Agent Orchestrator"),
    ("bul", "SCOUT — Agentic LOOP"),
    ("bul", "Veritas — RAG Pipeline"),
]
